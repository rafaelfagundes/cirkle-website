      ...
      <>
        ...
        >
          <Column>
            ...
            <StepCard position={2}>
              Preencha seus dados e as informações dos produtos. Verifique se
              eles são aceitos por nós.
            </StepCard>
            <SizedBox height={20}></SizedBox>
            <StepCard position={3}>
              Pronto, agora solicite o código para envio gratuito dos produtos
              via serviço postal, ou agende a retirada em casa (somente São João
              del Rei)
            </StepCard>
          </Column>
        </PageSection>
